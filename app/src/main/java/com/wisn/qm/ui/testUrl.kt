...
//    "imageSourceUrl": "https://static1.laiyifen.com/files/sns/image/f17020a0c3614316bf62c04e98dc3371.jpg?w=360&h=480&position=1",
    fun getVideoListMY(): List<VideoBean> {
        val videoList: MutableList<VideoBean> = ArrayList<VideoBean>()

        videoList.add(
            VideoBean(
                "111",
                Constant.getImageUrlThumb("d3889edd45da0a6c196b94bdeb8a00eeb02ac46b"),
                Constant.getImageUrl("d3889edd45da0a6c196b94bdeb8a00eeb02ac46b")
            )
        )
        videoList.add(
            VideoBean(
                "222",
                Constant.getImageUrlThumb("3719d0146a4add863c530712bfc68f0095ea9817"),
                Constant.getImageUrl("3719d0146a4add863c530712bfc68f0095ea9817")
            )
        )
        videoList.add(
            VideoBean(
                "333",
                Constant.getImageUrlThumb("eceb6f3522a5502667298fd61433966c8fe7ac1b"),
                Constant.getImageUrl("eceb6f3522a5502667298fd61433966c8fe7ac1b")
            )
        )
        ...
        videoList.add(
            VideoBean(
                "444",
                Constant.getImageUrlThumb("50e7cc4ec55da8388dc078322555d7fe1971089d"),
                Constant.getImageUrl("50e7cc4ec55da8388dc078322555d7fe1971089d")
            )
        )
        return videoList
    }
