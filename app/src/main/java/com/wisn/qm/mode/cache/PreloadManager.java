package com.wisn.qm.mode.cache;
...
public class PreloadManager {
    ...
    /**
     * 预加载的大小，每个视频预加载5M，这个参数可根据实际情况调整
     */
    ...
    public void pausePreload(int position, boolean isReverseScroll) {
        Log.i(TAG,"pausePreload：" + position + " isReverseScroll: " + isReverseScroll);
    ...
    public void resumePreload(int position, boolean isReverseScroll) {
        Log.i(TAG,"resumePreload：" + position + " isReverseScroll: " + isReverseScroll);
